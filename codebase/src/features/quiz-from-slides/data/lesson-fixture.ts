import type { LessonDay, QuizQuestion } from "../model/types";
...
export const lessonDays: LessonDay[] = [
  ...
  },
  {
    ...
    label: "Day 3",
    status: "ACTIVE",
    materials: [{ id: "day03-prompt", name: "day03-prompt-and-context.pdf", title: "Prompt và context", pages: 26, defaultPage: 9, scenario: "normal" }],
  },
  {
    id: 4,
    label: "Day 4",
    status: "ACTIVE",
    materials: [{ id: "day04-eval", name: "day04-evaluation.pdf", title: "Đánh giá output AI", pages: 36, defaultPage: 22, scenario: "normal" }],
  },
  {
    id: 5,
    label: "Day 5",
